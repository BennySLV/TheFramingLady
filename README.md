...
<p>This project is a prototype website for The Framing Lady - a former picture framing business. The website is designed using HTML, CSS and Bootstrap and developed using JavaScript/jQuery as well as PHP and MySQL.</p>
